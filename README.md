...
<div class="warning">
<p><em>*Imaster at HTML5, CSS3, JAVASCRIPT, BOOTSTRAP, and TAILWINDCSS. In addition, I have good graphic design skills with some platforms like Adobe XDand Figma. Besides, I can convert XD and Figma files to HTML. From my own experiences and skills, I can rapidly build a perfectly responsive website that can display on every device from mobile phones to laptops. I will use advanced CSS3 combined with pure javascript or Javascript Frameworks like React.js and Next.js . . . *</em></p>
</div>
